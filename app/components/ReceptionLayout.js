...
const navItems = [
  ...
  { path: "/reception/appointments", label: "Appointments & Queue", icon: AppointmentsIcon, section: "OPD & Patients", description: "Book & manage queue" },
  { path: "/reception/history", label: "Patient History", icon: HistoryIcon, section: "OPD & Patients", description: "Visit history by patient" },
  { path: "/reception/revenue", label: "Revenue & Invoices", icon: PaymentIcon, section: "Revenue & Invoices", description: "Total revenue, invoice, download report, hospital & doctor wise" },
  { path: "/reception/reports", label: "Reports", icon: ReportsIcon, section: "Reports", description: "Daily & doctor-wise reports" },
  { path: "/reception/prescriptions", label: "Prescription Report", icon: PrescriptionIcon, section: "Reports", description: "Doctor prescriptions view" },
];
